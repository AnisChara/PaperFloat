...
const ultime_placement = function(id,co_case_choisi,rotate,bateau)
{  
    ...
    let bateaux = fs.readFileSync("./bateaux/save_bateaux_"+id+".json");
    ...
    co_bateau = doublon(co_bateau,id, nb_bateau);
